...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapgoCapacitorInappbrowser", path: "../../../../../node_modules/.pnpm/@capgo+capacitor-inappbrowser@8.6.34_@capacitor+core@8.4.1/node_modules/@capgo/capacitor-inappbrowser")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
