...
import { Home, Search, Bell, TrendingUp, User, Wallet } from "lucide-react";
 ...
 * Tab order mirrors native MainTabs: Home → Search → Grow → Wallet → Bell → Profile.
 * Market is accessible via the mobile drawer (same as native's NavDrawerSheet).
 */
export function BottomNav({ active }: { active?: "grow" }) {
