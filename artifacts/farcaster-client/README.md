...
| `DATABASE_URL` | Optional | Postgres connection string for the points/airdrop action ledger (`server/db/`). Unset = ledger silently disabled, no other feature is affected |
